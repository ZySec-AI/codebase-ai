...
```bash
npm run build        # Build with tsup → dist/index.js (ESM, node18 target)
...
**TypeScript ESM project** — strict mode, ES2022 target, zero production dependencies. Built with tsup, tested with vitest.
